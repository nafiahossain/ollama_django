...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for property in properties:
            ...
            prompt = f"Rewrite the following property title and description in a more engaging way:\nTitle: {property.title}\nDescription: {property.description}"
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for property in properties:
            ...
            # Rewrite title and description
            prompt = f"""Rewrite the following property title and description in a more engaging way. 
            Please no matter what always format your response exactly like this: Title: and Description: 
